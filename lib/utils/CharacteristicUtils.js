module.exports = function(node) {
    ...
    const initAllCharacteristics = function (node, service, config) {
        ...
        // add characteristics resided
        for (const displayName in characteristicProperties){
            if (let characteristic = service.addCharacteristic(Charactertistic[displayName]){
                loadInitCharacteristicProperty(charactertistic,characteristicProperties[displayName]);
