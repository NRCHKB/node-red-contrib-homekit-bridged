module.exports = function(node) {
    ...
    const initAllCharacteristics = function (node, service, config) {
        ...
        for (let key in requiredCharacteristics) {
            ...
            if (requiredCharacteristics[key].props.perms.indexOf("pr") + requiredCharacteristics[key].props.perms.indexOf("ev") > -2 ) {
                supported.push(requiredCharacteristics[key].displayName.replace(/ /g, "").replace(/\./g, "_"));
            }
        };
