module.exports = function(node) {
    ...
    const getOrCreate = function(bridge, accessoryInformation) {
        ...
        debug(
            "Looking for accessory with UUID '" +
        ...
        if (!accessory) {
            ...
            accessory = new Accessory(
                accessoryInformation.name,
                accessoryInformation.UUID,
                //HapNodeJS.Accessory.Categories[accessoryInformation.category] // the constructor only has 2 parameters
            )
