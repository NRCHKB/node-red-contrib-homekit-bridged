...
//        node.characteristicProperties = CharacteristicUtils.loadCharacteristicProperties(service, config);
//        CharacteristicUtils.addCharacteristicListener(service, node);
